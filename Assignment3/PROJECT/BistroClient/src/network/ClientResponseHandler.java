 ...
 *
 * <p>Implementations of this interface are responsible for reacting to
 * server responses, handling connection errors, and responding to
 * connection termination events.</p>
 *
 * <p>This interface is typically used by the networking layer to decouple
 * low-level communication logic from higher-level application behavior.</p>
 */
