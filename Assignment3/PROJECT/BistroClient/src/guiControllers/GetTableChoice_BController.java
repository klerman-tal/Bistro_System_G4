 ...
 *
 * <p>
 * This screen acts as a navigation hub that lets the user choose whether to
 * proceed to a table-selection flow starting from an existing reservation or
 * from the waiting list. It preserves the current session context by passing
 * {@link User}, {@link ChatClient}, and (optionally) {@link ClientActions} to
 * the next screen controllers.
 * </p>
 */
