 ...
 *
 * <p>
 * This controller collects guest contact details (phone and/or email) along
 * with the reservation date and time, sends a recovery request to the server
 * via {@link ClientAPI}, and displays the recovered confirmation code in an
 * information dialog.
 * </p>
 *
 * <p>
 * The controller implements {@link ClientResponseHandler} to handle
 * asynchronous responses and connection events from the server.
 * </p>
 */
public class ForgotGuestConfirmationController implements ClientResponseHandler {
	 ...
	 *
	 * <p>
	 * Clears the error label and populates the time combo-box with half-hour
	 * increments for the full day (00:00..23:30).
	 * </p>
	 */
	@FXML
	 ...
	 *
	 * <p>
	 * Validates the input fields and sends a guest confirmation-code recovery
	 ...
	 *
	 * <p>
	 * On success, displays the recovered confirmation code and closes the window.
	...
	/**
	 * Closes the current window using an available injected node (phoneField) as an
	 * anchor.
	 */
