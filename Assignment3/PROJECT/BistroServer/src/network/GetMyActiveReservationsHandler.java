 ...
 * the active reservations of a specific user.
 * <p>
 * This handler processes user-specific reservation queries
 * and returns all currently active reservations associated
...
public class GetMyActiveReservationsHandler implements RequestHandler {
     ...
     * <p>
     * The method validates the request payload, delegates the retrieval
     * logic to the reservation controller, and sends the resulting
     * reservation list back to the client.
     * </p>
     */
    @Override
    public void handle(RequestDTO request, ConnectionToClient client) {
        ...
        ArrayList<Reservation> list =
                reservationController.getActiveReservationsForUser(dto.getUserId());
     ...
     * <p>
     * Any communication exception is caught and logged to prevent
     * server interruption.
     * </p>
     */
