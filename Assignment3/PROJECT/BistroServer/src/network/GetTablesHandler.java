 ...
 * <p>
 * This handler loads the tables data from the database
 * via the {@link RestaurantController} and returns the
 * full list of tables to the client.
 * </p>
 */
public class GetTablesHandler implements RequestHandler {
     ...
     * <p>
     * The method ensures the tables are loaded from the database,
     * retrieves the updated table list, and sends it back to the client.
     * </p>
     */
    @Override
