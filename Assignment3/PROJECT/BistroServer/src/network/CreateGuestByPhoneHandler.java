...
/**
 * Server-side request handler responsible for creating a guest user based on a
 * phone number.
 * <p>
 * This handler is restricted to restaurant staff roles (RestaurantAgent or
 * RestaurantManager) and allows them to create or log in a guest user using a
 * phone number.
 * </p>
 */
public class CreateGuestByPhoneHandler implements RequestHandler {
	 ...
	 * <p>
	 * The method verifies that the requesting user is authenticated and authorized,
	 * validates the input data, and delegates the guest creation logic to the
	 * {@link UserController}.
	 * </p>
	 */
	@Override
