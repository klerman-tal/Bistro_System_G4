...
/**
 * Server-side request handler responsible for retrieving all special opening
 * hours configurations.
 * <p>
 * This handler fetches special opening hours data from the database and returns
 * it to the client. Special opening hours typically represent exceptions to the
...
public class GetSpecialOpeningHoursHandler implements RequestHandler {
	 ...
	 * <p>
	 * The method loads all special opening hours records from the database and
	 * sends them back to the client as part of the response.
	 * </p>
	 */
	@Override
