 ...
 * the active waiting list entries of a specific user.
 * <p>
 * This handler processes user-specific waiting list queries
 * and returns all currently active waiting records associated
...
public class GetMyActiveWaitingsHandler implements RequestHandler {
     ...
     * logic to the waiting controller, and sends the resulting waiting
    ...
    public void handle(RequestDTO request, ConnectionToClient client) {
        ...
        ArrayList<Waiting> list =
                waitingController.getActiveWaitingsForUser(dto.getUserId());
