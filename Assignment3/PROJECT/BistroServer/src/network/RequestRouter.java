...
/**
 * Central router responsible for dispatching incoming client requests
 * to their corresponding {@link RequestHandler} implementations.
 * <p>
 * The router maintains a mapping between protocol {@link Commands}
 * and concrete request handlers. For each incoming request, it resolves
 * the appropriate handler and delegates the handling logic.
 * </p>
 * <p>
 * This class acts as the main entry point for server-side request
 * processing and enforces a clean separation between network transport
 * and business logic.
 * </p>
 */
public class RequestRouter {
    ...
    /**
     * Routes an incoming request to the appropriate handler based
     * on its protocol command.
     * <p>
     * If no handler is registered for the requested command, an
     ...
     * <p>
     * This helper method centralizes error handling for network
     * transmission and prevents the routing flow from crashing
     * due to I/O errors.
     * </p>
     *
