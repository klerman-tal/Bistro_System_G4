...
/**
 * Server-side request handler responsible for creating or updating restaurant
 * table definitions.
 * <p>
 * This handler receives table configuration data from the client, constructs a
 * {@link Table} entity, and delegates persistence logic to the
 * {@link RestaurantController}.
 * </p>
 * <p>
 * The same handler supports both ADD and UPDATE operations, depending on
 * whether the table number already exists.
 * </p>
 */
public class SaveTableHandler implements RequestHandler {
	...
	public void handle(RequestDTO request, ConnectionToClient client) {
		try {
			...
			client.sendToClient(new ResponseDTO(true, "Table saved successfully", null));
