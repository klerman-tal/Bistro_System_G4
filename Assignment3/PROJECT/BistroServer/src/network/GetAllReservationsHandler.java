 ...
 * the complete reservations history.
 * <p>
 * This handler fetches all reservation records from the system
 * via the {@link ReservationController} and returns them to
 * the client.
 * </p>
 */
public class GetAllReservationsHandler implements RequestHandler {
     ...
     * <p>
     * The method loads the full reservations history and sends it
     * back to the client as part of the response.
     * </p>
     */
    @Override
