...
/**
 * Server-side request handler responsible for processing receipt payment
 * operations.
 * <p>
 * This handler validates payment details, verifies session ownership, ensures
 * reservation eligibility for payment, marks the receipt as paid, finalizes the
 * reservation, and performs post-payment cleanup when required.
 * </p>
 */
public class PayReceiptHandler implements RequestHandler {
	 ...
	 */
	public PayReceiptHandler(ReservationController reservationController, ReceiptController receiptController,
	 ...
	 * <p>
	 * The method validates the payment data, verifies that the requesting user owns
	 * the reservation, checks reservation and receipt status, processes the
	 * payment, finalizes the reservation, and removes temporary guest users when
	 * applicable.
	 * </p>
	 */
	@Override
	public void handle(RequestDTO request, ConnectionToClient client) throws Exception {
		...
		boolean paid = receiptController.markPaid(r.getReservationId(), dto.getPaymentType(),
