 ...
 * the list of current diners in the restaurant.
 * <p>
 * This handler fetches active reservations representing
 * diners currently seated in the restaurant and converts
 * them into lightweight DTO objects for client display.
 * </p>
 */
public class GetCurrentDinersHandler implements RequestHandler {
     ...
     * <p>
     * The method loads active diner reservations, maps them
     * to {@link CurrentDinerDTO} objects, and sends the result
     * back to the client.
     * </p>
     */
    @Override
