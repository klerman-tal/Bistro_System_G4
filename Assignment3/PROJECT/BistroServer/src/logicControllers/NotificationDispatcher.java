...
/**
 * Dispatches notifications to users through different simulated channels
 * (SMS / EMAIL).
 * <p>
 ...
 * </p>
 * <p>
 * The dispatcher relies on {@link OnlineUsersRegistry} to determine whether
 * a user is currently connected, and uses a {@link Consumer} logger instead
...
public class NotificationDispatcher {
     ...
     *
     * @param onlineUsers registry used to resolve online users and their connections
     ...
     *   <li><b>SMS</b>: sent as a popup notification to the client if the user is online</li>
     * </ul>
     * </p>
     * <p>
     * For SMS notifications, a safe display message is shown in the UI,
     * while the full message content is preserved in the simulated SMS body.
     * </p>
     *
     ...
     * <p>
     * This method ensures that sensitive information (such as confirmation
     * codes) is not displayed directly in the UI. The returned text depends
