 ...
 * </p>
 * <p>
 * This class is safe for concurrent access and can be used by multiple
 * server threads simultaneously.
 * </p>
 */
public class OnlineUsersRegistry {
     ...
     */
    private final Map<Integer, ConnectionToClient> userIdToClient =
            new ConcurrentHashMap<>();

    /**
     * Registers a user as online by associating the given user ID
    ...
    /**
     * Convenience method for registering a user as online using
     * a {@link User} object.
     * <p>
     * This method extracts the user ID from the given user and
     * delegates to {@link #setOnline(int, ConnectionToClient)}.
     * </p>
     *
    ...
    /**
     * Marks a user as offline by removing their association
     * from the registry.
     *
     * @param userId the unique identifier of the user
     */
     ...
     *
     * @param userId the unique identifier of the user
     * @return the corresponding {@link ConnectionToClient}, or {@code null}
     ...
     * <p>
     * This method is typically invoked when a client disconnects unexpectedly
     * and the server needs to clean up stale connections.
     * </p>
     *
