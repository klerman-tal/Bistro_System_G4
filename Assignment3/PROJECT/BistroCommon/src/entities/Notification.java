...
public class Notification {
	...
	/**
	 * Constructs a new notification instance intended for insertion into the
	 * database.
	 * <p>
	 * The notification is initialized as not sent.
	 * </p>
	 */
	public Notification(int userId, Channel channel, NotificationType notificationType, String message,
	 ...
	 * <p>
	 * This constructor is typically used when reconstructing the entity from
	 * persisted data.
	 * </p>
	 */
	public Notification(int notificationId, int userId, Channel channel, NotificationType notificationType,
			String message, LocalDateTime scheduledFor, boolean sent, LocalDateTime sentAt) {
