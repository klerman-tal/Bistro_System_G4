 ...
 * <p>
 * This class stores basic table information such as the table number and
 * seating capacity. It is used for reservation allocation, availability checks,
...
public class Table implements Serializable {
	 ...
	 * Default constructor.
	 * <p>
	 * Initializes a table with default values. Typically used for framework support
	 * or database mapping.
	 * </p>
	 */
	public Table() {
