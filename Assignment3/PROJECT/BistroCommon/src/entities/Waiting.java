...
public class Waiting implements Serializable {
	...
	/**
	 * Generates and assigns a random six-digit confirmation code for this waiting
	 * list entry.
	 * <p>
	 * The confirmation code is used to identify the waiting request from the user's
	 * perspective.
	 * </p>
	 */
