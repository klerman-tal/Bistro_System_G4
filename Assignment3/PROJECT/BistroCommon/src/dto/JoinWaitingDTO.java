...
/**
 * Data Transfer Object (DTO) used to request joining the restaurant
 * waiting list.
 * <p>
 * This object is sent from the client to the server and contains
 * information about the number of guests, the user identifier,
 * and the user's role in the system.
 * </p>
 */
