...
public class PayReceiptDTO implements Serializable {
    ...
    public PayReceiptDTO(String confirmationCode,
                         Enums.TypeOfPayment paymentType,
                         Integer last4Digits,
                         String expiryDate,
                         Integer cvv) {
    ...
    public Enums.TypeOfPayment getPaymentType() { return paymentType; }
    public Integer getLast4Digits() { return last4Digits; }
