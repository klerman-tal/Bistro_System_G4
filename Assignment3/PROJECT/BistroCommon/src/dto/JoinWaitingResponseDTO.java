...
/**
 * Data Transfer Object (DTO) used to return the result of a join waiting list
 * request.
 * <p>
 * This object is sent from the server to the client and contains the waiting
 * confirmation code, the current waiting status, and an optional table number
 * if a table was assigned immediately.
 * </p>
 */
public class JoinWaitingResponseDTO implements Serializable {
	...
	public String getWaitingConfirmationCode() {
		return waitingConfirmationCode;
	}
