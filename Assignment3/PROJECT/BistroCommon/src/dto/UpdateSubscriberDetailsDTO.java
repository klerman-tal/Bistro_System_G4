...
/**
 * Data Transfer Object (DTO) used to update subscriber details between the
...
public class UpdateSubscriberDetailsDTO implements Serializable {
	...
	public UpdateSubscriberDetailsDTO(int subscriberId, String username, String firstName, String lastName,
