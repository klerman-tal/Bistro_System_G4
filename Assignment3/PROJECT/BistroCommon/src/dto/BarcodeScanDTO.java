 ...
 * <p>
 * This DTO is used to transfer a scanned subscriber identifier
 * from an external barcode scanner simulator to the server.
 * </p>
 */
public class BarcodeScanDTO implements Serializable {
     ...
     *
     * @param subscriberId the identifier of the subscriber obtained from the barcode scan
     */
