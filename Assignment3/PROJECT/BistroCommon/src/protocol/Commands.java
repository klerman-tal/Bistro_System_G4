 ...
 * <p>
 * Each command represents a specific action or request that can be sent
 * from the client to the server. These commands are used to route requests
 * to the appropriate logic handlers on the server side.
 * </p>
 */
